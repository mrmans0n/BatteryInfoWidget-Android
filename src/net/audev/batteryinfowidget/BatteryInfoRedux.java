...
public class BatteryInfoRedux extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
		...
		Log.d(TAG,"++ onUpdate");		
		context.startService(new Intent(context, UpdateWidgetServiceRedux.class));	
		Log.d(TAG,"-- onUpdate");
	}
	 ...
	 */
	public static class UpdateWidgetServiceRedux extends Service {		
		...
		public void onStart(Intent intent, int startId) {        	
            ...
            thisWidget = new ComponentName(this, BatteryInfoRedux.class);
		...
		public RemoteViews buildUpdate(Context context)
		{
			...
			RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.battwidget_redux);					
			...
			views.setTextViewText(R.id.temp, ((double)BatteryInfoData.getInstance().temp/10.0)+"ºC");
